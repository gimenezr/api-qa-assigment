...
//     expect(createdPost.body.id, "The expected id is not valid").be.greaterThan(0);
...
//     await remove(`/users/${createdUser.id}`).send().expect(204);

//     const response = await get(`/users/${createdUser.id}`).send().expect(404);
